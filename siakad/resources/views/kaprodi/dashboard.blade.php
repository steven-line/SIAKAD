...
<div class="min-h-screen bg-gray-900 p-6 text-white">
    ...
    <div class="mb-8">
        ...
        <p class="text-gray-400 mt-1">
            Sistem Informasi Akademik - Dashboard Ketua Program Studi ({{ auth()->user()->dosen->prodi }})
        </p>
    </div>

    <div class="bg-gray-800 p-6 rounded-lg shadow max-w-md">
        <h2 class="font-semibold mb-4 text-lg text-primary">Informasi Akun Kaprodi</h2>
