<x-layout title="KHS Mahasiswa">
    ...
    <div class="container mx-auto p-4">
        <h1 class="text-2xl font-bold mb-2">Hasil KHS Mahasiswa</h1>
        <p class="mb-4">Di bawah ini nilai KHS [transkrip nilai] mahasiswa yang telah ditempuh selama ini.</p>
        ...
        @forelse ($results as $semester)
            <div class="mb-8">
                <h2 class="text-xl font-semibold mb-2 bg-transparent p-2 rounded">
                ...
                <div class="mt-2 text-sm font-semibold">
                    ...
                    <span class="mr-4">TOTAL SKS : {{ $semester->total_sks }}</span>
                    <span>Total Mutu : {{ number_format($semester->total_mutu, 1) }}</span>
                </div>
        ...
        <div class="mt-6 p-4 bg-transparent rounded">
            <p><strong>Total SKS yang telah ditempuh :</strong> {{ $total_sks_tempuh ?? 0 }} SKS</p>
