    ...
    @else
        ...
        @if(!empty($periodePengumuman))
            ...
            <div role="alert" class="alert alert-warning mb-6">
                <div>
                    ...
                    <div class="mt-1">
                        Nilai <b>Kartu Hasil Studi (KHS)</b> sedang tidak dapat diakses karena sedang dalam periode
        ...
        @else
            ...
            <div class="container mx-auto p-4">
                ...
                <p class="mb-4">
                    Dibawah ini Nilai KHS [Transkrip Nilai] Anda yang telah anda tempuh selama ini
                </p>
                ...
                @forelse ($results as $semester)
                    ...
                    <div class="mb-8">
                        ...
                        <div class="mt-2 text-sm font-semibold">
                            <span class="mr-4">
                                Nilai IPS : {{ number_format($semester->ips, 3) }}
                            </span>

                            <span class="mr-4">
                                TOTAL : {{ $semester->total_sks }}
                            </span>

                            <span>
                                {{ number_format($semester->total_mutu, 1) }}
                            </span>
                        </div>

                        <div class="mt-1 text-sm">
                            SKS Maksimum yang dapat diambil Semester Depan :
                            {{ $semester->max_sks }}
                        </div>
                ...
                <div class="mt-6 p-4 bg-transparent rounded">
                    <p>
                        <strong>Total SKS yang sudah anda Tempuh :</strong>
                        {{ $total_sks_tempuh ?? 0 }} SKS
                    </p>

                    <p>
                        <strong>Nilai IPK :</strong>
