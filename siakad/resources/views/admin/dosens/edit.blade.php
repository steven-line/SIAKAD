<x-layout>
    ...
    <form action="/admin/kelola-dosen/{{ $dosen->nim_dosen }}" method="POST">
        @csrf
        @method('PATCH')
        ...
        <fieldset class="fieldset bg-base-200 border-base-300 rounded-box w-full max-w-sm border p-6 mx-auto">
            ...
            <input type="text"  class="input w-full" name="jabatan_struktural" placeholder="Masukkan jabatan struktural" required value="{{ $dosen->jabatan_struktural }}" />
