<x-layout title="index">
 <div class="overflow-x-auto rounded-box border border-base-content/5 bg-base-100">
    <a class="btn btn-primary text-white mb-6" href="/admin/kelola-biodata/create">Create Biodata</a>
  <table class="table">
    <!-- head -->
        ...
        <tr>
            ...
            <td>
              ...
              <dialog id="deleteBox_{{$biodata->nrp}}" class="modal modal-bottom sm:modal-middle">
                <div class="modal-box">
                  ...
                  <div class="modal-action">
                    <form method="dialog">
                      ...
                      <button class="btn btn-primary" form="delete-biodata-form-{{$biodata->nrp}}">Ya</button>
               ...
               <form id="delete-biodata-form-{{$biodata->nrp}}" action="/admin/kelola-biodata/{{ $biodata->nrp }}" method='POST'>
            @csrf  
            @method('DELETE')
       </form>
