...
class MkController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Mk::create([
            ...
            'prasyarat1'  => $request->filled('prasyarat1') ? $request->prasyarat1 : '-',
            'prasyarat2'  => $request->filled('prasyarat2') ? $request->prasyarat2 : '-',
            'prasyarat3'  => $request->filled('prasyarat3') ? $request->prasyarat3 : '-',
            'prasyarat4'  => $request->filled('prasyarat4') ? $request->prasyarat4 : '-',
            'prasyarat5'  => $request->filled('prasyarat5') ? $request->prasyarat5 : '-',
            'prasyarat6'  => $request->filled('prasyarat6') ? $request->prasyarat6 : '-',
            'prasyarat7'  => $request->filled('prasyarat7') ? $request->prasyarat7 : '-',
            'prasyarat8'  => $request->filled('prasyarat8') ? $request->prasyarat8 : '-',
            'prasyarat9'  => $request->filled('prasyarat9') ? $request->prasyarat9 : '-',
            'prasyarat10' => $request->filled('prasyarat10') ? $request->prasyarat10 : '-',
